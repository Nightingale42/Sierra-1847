...
public class LookAt4P2 : MonoBehaviour
{
    ...
    public D3P2Caminteract D3P2CamInteract;
    ...
    private void OnAnimatorIK(int layerIndex)
    {
        ...
        if (this.gameObject.GetComponent<Animator>())
        {
            ...
            if(D3P2CamInteract.TalkToActualFriend == true)
            {
            ...
            else if(D3P2CamInteract.TalkToRedFriend == true)
            {
