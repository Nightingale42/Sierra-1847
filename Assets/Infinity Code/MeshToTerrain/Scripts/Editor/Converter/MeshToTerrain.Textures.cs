...
namespace InfinityCode.MeshToTerrain
{
    public partial class MeshToTerrain
    {
        ...
        private void UpdateTextureCamera(Terrain t)
        {
            ...
            Vector3 curPoint = t.transform.position + new Vector3(prefs.textureWidth / 2 * vScale.x, 0, prefs.textureHeight / 2 * vScale.z);
            ...
            {
                curPoint.y = (maxBounds.y + 10) * boundsRange.y / originalBoundsRange.y;
            }
            else
            {
                curPoint.y = (maxBounds.y - 10) * boundsRange.y / originalBoundsRange.y;
            ...
            Texture2D texture = RenderCamera(curPoint, mLayer, (boundsRange.y + 20) * boundsRange.y / originalBoundsRange.y);
